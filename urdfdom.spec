...
%changelog
* Wed May 20 2026 Morgan Hough <morgan.hough@gmail.com> - 4.0.2-2
- Revive from Fedora orphan state (was dropped after F42, August 2025).
- Imported F42 spec unchanged; rebuilt for F44 against urdfdom-headers
  1.1.2-3 from the COPR (same chain).
- Third step in reviving the urdfdom-headers / urdfdom / fcl / DART chain.
